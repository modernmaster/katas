...
import uk.co.mcguigan.trains.networkcalculatorservices.RailwayNetworkServiceImpl;
...
public class KiwilandRailwayNetworkCalculatorTests {
    ...
    public void testCalculationOfTheDistanceOfRouteABCAs9() {
        ...
        String distance = railwayNetworkService.calculateDistance(railwayJourney);
    ...
    public void testCalculationOfTheNumberOfTripsStartingAndFinishingAtCWithMaxThreeStopsAs2() {
        ...
        Integer numberOfRoutes = railwayNetworkService.calculateNumberOfRoutesWithExactNumberOfStops(start, finish, maximumNumberStops);
    ...
    public void testCalculationOfTheShortestRouteFromAtoCInTermsOfDistanceToTravelAs9() {
        ...
        String distance = railwayNetworkService.calculateShortestDistance(startStation, endStation);
    ...
    public void testCalculateTheNumberOfDifferentRoutesFromCToCWithADistanceOfLessThan30As7() {
        ...
        Integer numberOfRoutes = railwayNetworkService.calculateNumberOfRoutesUnderASetDistance(start, finish, maximumNumberDistance);
